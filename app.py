...
# Estado inicial de ítems (estilo GlobalTrip: agregado/eliminado por tarjetas)
DEFAULT_ITEMS = [
...
# Builder de un ítem visual similar al de "Bultos"
...
def build_pdf() -> bytes:
    ...
    # Nombres únicos para evitar KeyError (algunos ya existen)
    for (name, kwargs) in [
